  ...
  return (
    <SiteLayout>
      <Section className="!pt-16 !pb-8">
        <SectionHeading eyebrow="Meet the crew" title="The team behind every reel" subtitle="A small, multidisciplinary team of directors, editors, creators and strategists." />
      </Section>
      ...
      <Section className="!pt-4">
        {loading ? (
          ...
          <div className="text-center py-20">
            <p className="text-muted-foreground">No team members yet. Add some from the admin panel!</p>
          </div>
        ) : (
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {members.map((m, i) => (
              <Link key={m.id} to="/team/$slug" params={{ slug: m.slug }} className="group bg-card rounded-3xl overflow-hidden border hover:shadow-2xl hover:-translate-y-2 transition-all animate-fade-up" style={{ animationDelay: `${i * 0.06}s` }}>
