      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 pt-10 md:pt-16 pb-12">
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative animate-fade-up" style={{ animationDelay: "0.2s" }}>
            <div className="absolute -inset-8 rounded-[3rem] opacity-60 pointer-events-none" style={{ background: "radial-gradient(closest-side, oklch(0.85 0.15 0 / 0.55), transparent 70%)" }} aria-hidden />
